...
class Carousel extends Component {
  ...
  [...this.props.children, ...(this.props.children.slice(0, this.props.slidesToShow))].map((item, index) =>
    (<li
      key={index}
      className={`rc-carousel-item${this.state.selectedItem === index ? ' active' : ''}`}
  ...
  render() {
    ...
    return (
      <div className="rc-carousel-wrapper" ref={(ref) => { this.wrapper = ref; }}>
        <div className="rc-carousel-railroad">
          <ul className="rc-carousel-stage" style={ulStyle}>
            {this.renderItems()}
          </ul>
          {this.props.arrows &&
          <ul className="rc-carousel-arrows center-vertical">
            {this.renderArrows()}
          </ul>
        }
        </div>
        {this.props.dots &&
          <ul className="rc-carousel-dots">
            {this.renderDots()}
          </ul>
        }
      </div>
