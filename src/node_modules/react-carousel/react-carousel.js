...
class Carousel extends Component {
  ...
  handleChangeSlide = (index, clickedOnControlls, clickedOnLeftArrow) => {
    ...
    // if (this.state.transitionTime === 0) {
    //   currentSlide = 0;
    //   this.setState({
    //     transitionTime: this.props.transitionTime
    //   });
  ...
  render() {
    ...
    console.log([...this.props.children, ...this.props.children.slice(0, this.props.slidesToShow)]);
    ...
    const transitionTime = `${this.state.transitionTime}ms`;
    const ulStyle = {
